      ...
      <Modal
        ...
        onConfirm={() => {
          ...
          run(v => {
            ...
            const cells = Array.from({ length: cols }, () => schema.nodes.table_cell.createAndFill()).filter((n): n is NonNullable<typeof n> => n != null)
            const headerCells = Array.from({ length: cols }, () => schema.nodes.table_header.createAndFill()).filter((n): n is NonNullable<typeof n> => n != null)
